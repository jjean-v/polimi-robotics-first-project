...
#include "custom_msg_demo/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg_demo
cdr_serialize(
  const custom_msg_demo::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg_demo::msg::RobotStatus & ros_message)
{
  // Member: robot_name
  cdr >> ros_message.robot_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg_demo::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msg_demo::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg_demo::msg::RobotStatus *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_custom_msg_demo
const rosidl_message_type_support_t *
get_message_type_support_handle<custom_msg_demo::msg::RobotStatus>()
{
  return &custom_msg_demo::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg_demo, msg, RobotStatus)() {
  return &custom_msg_demo::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
