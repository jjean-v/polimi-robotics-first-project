...
- COMPUTED_GEAR_RATIO :     has been computed from the real velocity and the theoretical equation. 
...
To keep it readable in a terminal but see smooth movements in rviz2, we ended up choosing 250ms.